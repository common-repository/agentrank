...
global $agapi;
$xml = $agapi->view_all_reviews($start, $display);
...
// Determine how many pages there are.
  ...
  $htm = "<div class='agentrank_reviews'>";
  $htm .= "<h2 class='all_reviews_title'>View All Client Reviews</h2>";
  if ($status_code = "200") {
    ...
    foreach ($xml->charts->image as $image) {
      ...
      $htm .= "<div class='agentrank-chart' style='width:50%;'><img src='$image_url' width='$image_width' height='$image_height' alt='$image_title'/></div>";
    }
    $htm .= "</div>";
    $htm .= "<br clear='both'/>";
    $htm .= "<ul>";
    foreach ($xml->reviews->review as $review) {
      ...
      $htm .= "<li><a href='$review_url'>" . $title . "</a></li>";
    }
    $htm .= "</ul>";
  }
